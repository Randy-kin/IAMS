...
public class customer extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String bill=jTextArea1.getText();
        String ship=jTextArea2.getText();
        String bank=jTextField7.getText();
        String city=jTextField8.getText();
        String p_name=jTextField9.getText();
        String p_contact=jTextField10.getText();
        String p_tp=jTextField11.getText();
        String email=jTextField12.getText();
        String online=jTextField13.getText();
        
        
        try{
            
            Statement s=db.mycon().createStatement();
            s.executeUpdate("INSERT INTO customer(Customer_Name,T_PNumber,BillingAddress,ShipingAddress,BankAccountNo,City,Person_Name,PersonContact,Person_TP,PersonEmail,PersonOnline) VALUES('"+C_name+"','"+tp+"','"+bill+"','"+ship+"','"+bank+"','"+city+"','"+p_name+"','"+p_contact+"','"+p_tp+"','"+email+"','"+online+"') ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Statement s=db.mycon().createStatement();
            ResultSet rs=s.executeQuery("SELECT * FROM customer WHERE cus_id='"+search+"' ");
            
            if(rs.next()){
                jTextField2.setText(rs.getString("Customer_Name"));
                jTextField1.setText(rs.getString("T_PNumber"));
                jTextArea1.setText(rs.getString("BillingAddress"));
                jTextArea2.setText(rs.getString("ShipingAdress"));
                jTextField7.setText(rs.getString("BankAccountNo"));
                jTextField8.setText(rs.getString("City"));
                jTextField9.setText(rs.getString("Person_Name"));
               jTextField10 .setText(rs.getString("PersonContact"));
                jTextField11.setText(rs.getString("Person_TP"));
                jTextField12.setText(rs.getString("PersonEmail"));
                jTextField13.setText(rs.getString("PersonOnline"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            Statement s=db.mycon().createStatement();
            s.executeUpdate("UPDATE customer SET Customer_Name='"+C_name+"',"
                    + "T_Pnumber='"+tp+"'"
                    + ",BillingAddress='"+bill+"'"
                    + ",ShipingAddress='"+ship+"'"
                    + ",BankAccountNo='"+bank+"'"
